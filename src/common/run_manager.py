...
class RunManager(object):
    def __init__(self):
        ...
        self.parser.add_argument("--model_dir", type=str, default="models", help="Directory containing all model checkpoints (created automatically)")
        self.parser.add_argument("--model", type=str, default="", help="Model filename for resuming training, evaluation, or single-model design (relative to model_dir)")
        self.parser.add_argument("--model_list", "--list", nargs="+", help="Model filenames for ensemble design (averages predictions). If not specified, uses --model (relative to model_dir)",
                                 default=[])
        ...
        self.parser.add_argument("--wandb_path", type=str, default="logs", help="directory for wandb logs")
        self.parser.add_argument("--pdb_dir", type=str, default="data/pdb", help="directory containing input PDB/CIF files")
        self.parser.add_argument("--log_dir", type=str, default="output", help="where the outputs will be dumped")
        self.parser.add_argument("--save_dir", type=str, default="data/coords/train", help="where coordinates for training are stored")
        self.parser.add_argument("--input_data", type=str, default="data/train.csv", help="default input data file for training")
        self.parser.add_argument("--coord_dir", type=str, default="data/coords/train", help="path for training data coordinates")

        # design inputs
        self.parser.add_argument("--pdb", type=str, default="", help="Input PDB or CIF")
        self.parser.add_argument("--chain", type=str, default=None, help="which chain, default is all chains")
        self.parser.add_argument("--test_csv", type=str, default="data/test.csv", help="Path to CSV file with test PDB codes and chain IDs")
        self.parser.add_argument("--test_coords_dir", type=str, default="data/coords/test", help="Directory containing test coordinate files")
        ...
        self.parser.add_argument("--anneal", type=int, default=1, choices=(0, 1),
